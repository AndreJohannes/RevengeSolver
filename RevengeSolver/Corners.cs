...
namespace RevengeSolver {
	...
	public class Corner {
		...
		public static Corner URB = new Corner (Faces.U, Faces.R, Faces.B);
		public static Corner ULF = new Corner (Faces.U, Faces.L, Faces.F);
		public static Corner DLF = new Corner (Faces.D, Faces.L, Faces.F);
		public static Corner DRB = new Corner (Faces.D, Faces.R, Faces.B);
		public static Corner DRF = new Corner (Faces.D, Faces.R, Faces.F);
		public static Corner DLB = new Corner (Faces.D, Faces.L, Faces.B);
